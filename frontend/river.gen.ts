...
const routes = [
	{
		...
		params: [],
		pattern: "/_index",
		phantomOutputType: null as unknown as GoInfo,
	},
] as const;
...
export type MemoryStats = {
	...
	LastGC: number;
	PauseTotalNs: number;
	PauseNs: Array<number>;
	PauseEnd: Array<number>;
	NumGC: number;
	NumForcedGC: number;
			...
			return {
				...
				resolve: {
					...
					dedupe: [
						...
						...["preact","preact/hooks","@preact/signals","preact/jsx-runtime","preact/compat","preact/test-utils"]
					],
				},
			};
		},
